...
export const initialPackages: Package[] = [
  { id: 'pkg-1', name: 'Basic', speed: '15 Mbps', monthlyCharges: 1200, installationCharges: 2000, status: 'Active' },
  { id: 'pkg-2', name: 'Bronze', speed: '35 Mbps', monthlyCharges: 2000, installationCharges: 1500, status: 'Active' },
  { id: 'pkg-3', name: 'Silver', speed: '60 Mbps', monthlyCharges: 3000, installationCharges: 1000, status: 'Active' }
];
...
export const initialNotifications: Notification[] = [
  {
    ...
    message: 'FNB-1001 (Muhammad Ali) paid PKR 3,450 via EasyPaisa.',
